...
public class JsonParserTest  extends ParserTest {
    ...
    public void testHappyPath() throws IOException {
        LogSource<String> jsonSource = createLogSource(LogSources.ZEEK_SOURCE_NAME);
        ...
        verifyField(event, LogEvent.IP_SRC_ADDR_FIELD, "172.31.1.6");
        verifyField(event, LogEvent.IP_SRC_PORT_FIELD, 13512L);
        verifyField(event, LogEvent.IP_DST_ADDR_FIELD, "172.31.3.121");
        verifyField(event, LogEvent.IP_DST_PORT_FIELD, 53L);
    ...
    public void testBadFormat() throws IOException {
        LogSource<String> logSource = createLogSource(LogSources.ZEEK_SOURCE_NAME);
        ...
        LogEventTest.checkLogEventError(LogEvent.ORIGINAL_STRING_FIELD_NAME, JsonParser.JSON_PARSER_FEATURE,
