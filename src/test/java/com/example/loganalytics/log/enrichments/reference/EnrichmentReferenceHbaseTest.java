...
public class EnrichmentReferenceHbaseTest {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            parameters.put(EnrichmentReferenceHbase.HBASE_URL_PROPERTY_NAME, "jdbc:phoenix:ec2-3-101-39-186.us-west-1.compute.amazonaws.com:2181/".concat(EnrichmentReferenceHbase.ENRICHMENTS_SCHEMA));
            ...
            Map<String, Object> bad_site_enrichments = enrichments.getEnrichmentValue("malicious_host", "www.badsite.com");
            LOG.info("Bad site enrichments {}.", bad_site_enrichments.toString());
            Map<String, Object> good_site_enrichments = enrichments.getEnrichmentValue("malicious_host", "www.goodsite.com");
